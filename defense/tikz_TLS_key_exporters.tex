...
\begin{tikzpicture}
	...
	\node[draw, below=30pt of midpoint,inner sep = 5pt,align=center] {$ck \gets \mathsf{tls.PRF}(ms,``\mathtt{key\ expansion}", n_C \Vert n_S)$\\$ek \gets \mathsf{tls.PRF}(ms,\textcolor{red}{``\mathtt{some\ label}"}, n_C \Vert n_S)$};
