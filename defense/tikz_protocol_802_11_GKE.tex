...
%	},
	...
	\node[above = 0 of A] {\includegraphics[width=0.15\textwidth]{laptop}};
	\node[above = 0 of B] {\includegraphics[width=0.15\textwidth]{laptop}};
	\node[above = 0 of C] {\includegraphics[width=0.15\textwidth]{laptop}};
	\node[above = 0 of D] {\includegraphics[width=0.15\textwidth]{AP}};
	...
	\uncover<+-+>{
		\node[above right =-0.6cm and -5pt of d6, align=left] {$\ua{\mathsf{GK}} \gets \mathsf{CreateKey}$};
